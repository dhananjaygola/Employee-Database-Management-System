...
private: System::Void btnPaySlip_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	rtReceipt->AppendText("City Weight :" + "\t\t" + txtWeight->Text + "\n");
	...
	rtReceipt->AppendText("HI Payment :" + "\t\t" + txtNIPayment->Text + "\n");
	rtReceipt->AppendText("PayDate :" + "\t\t\t" + dateTimePicker1->Text + "\n");
	rtReceipt->AppendText("TaxPeriod :" + "\t\t" + txtTaxPeriod->Text + "\n");
	rtReceipt->AppendText("IFSC Code :" + "\t\t" + txtTaxCode->Text + "\n");
	rtReceipt->AppendText("Account No :" + "\t\t" + txtNINumber->Text + "\n");
	rtReceipt->AppendText("PAN Code :" + "\t\t" + txtNICode->Text + "\n");
