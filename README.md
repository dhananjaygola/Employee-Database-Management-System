...
<p align="center">
    <img alt="Click to see the source" src="demo/images/meme.png" width="320" />
  </p>
...
<!--ts-->
   ...
   * [**How to use the project**](#how-to-use-the-project)
      ...
      * [Print pay slip or save as pdf](#print)
      * [Delete record of an employee](#delete)
      * [Search using employee's firstname](#search)
      * [Refresh data in grid view](#refresh)
      * [Reset all input fields](#reset)
